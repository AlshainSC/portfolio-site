    ...
    <div className="flex flex-col items-center" ref={flexContainerRef}>
      <nav className="py-4 fixed top-0 flex flex-col justify-center">
        ...
        >
          <Link
            href="/home"
            className="text-gray-200 pointer-events-auto font-medium hover:text-white transition-colors mr-4"
          >
            Home
          </Link>
          ...
          <Link
            href="/contact"
            className="text-gray-200 pointer-events-auto font-medium hover:text-white transition-colors"
          >
            Contact
          </Link>
        </div>
        <div className=" flex h-2 relative ">
          <animated.span
            ...
            style={{
              ...bottomDividerProps,
              backgroundColor: bottomDividerProps.width.to((width) =>
                +width <= 30 ? "gray" : "#8abf9e"
              )
            }}
          ></animated.span>
        </div>
